module.exports = {
  ...
  embed: {
    ...
    footertext: "Developed By Sithum! | The ITech",
    footericon: " ",
  },
  emoji: {
    ERROR: "❌",
  ...
  links: {
    inviteURL:
      ...
      `https://discord.com/api/oauth2/authorize?client_id=1044113552480411711&permissions=693682817344&scope=bot`,
    DiscordServer: process.env.DiscordServer || `https://discord.gg/znDJKzzcbm`,
    VoteURL: process.env.VoteURL || `https://discord.gg/znDJKzzcbm`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true
